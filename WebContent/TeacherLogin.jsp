  ...
  <body class = "bg-light">
	...
	<div class = "text-center mt-5">
		<form style = "max-width:300px; margin:auto;">
			<h1 class="h3 mt-4 font-weight-normal">Teacher Login</h1>
			<div class="form-floating mt-3">
				<input type = "text" class="form-control" id = "username" name = "tusername" placeholder="UserName" required>
				<label for="username" class= "sr-only">UserName</label>
			</div>
			<div class="form-floating mt-2">
				<input type="password" class="form-control" id = "password" name = "tpassword" placeholder="Password" required>
...
try{ 
	...
	System.out.println(user + " "  + pass); 
		...
		Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3309/feedbackdb?autoReconnect=true&useSSL=false"
						                             ,"root","vaishali@97"); 
		PreparedStatement stmt=con.prepareStatement("select * from teacher where tusername = ? and tpassword = ?");

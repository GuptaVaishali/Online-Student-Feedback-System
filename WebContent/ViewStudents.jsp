...
<body>
	...
	<header id="header">
      <div class="container bg-smoky-white">
        <div class="row">
          <div class="col-md-12">
            <h1 class="text-center text-muted">Manage Students</h1>
          </div>
        </div>
      </div>
    </header>
   ...
   <%  if( session.getAttribute("message") != null){ %> 
	    ...
	    <div class="modal-content">
	      <div class="modal-header">
	        ...
	        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
	      	...
	      	<form name = "AddStudentForm" action = "Add_Student.jsp" method = "get" onsubmit = "return fun()">
	      	<div class="modal-body">
	      		<div class="mb-3">
					  <label for="sname1" class="form-label">Student Name</label>
					  <input type = "text" class="form-control" name = "sname" id = "sname1" required placeholder = "Enter Name">
				</div>
				<div class="mb-3">
					  <label for="suname" class="form-label">Student UserName</label>
					 <input type = "text" class="form-control" name = "susername" id ="suname" required placeholder = "Enter Username">
				</div>
				<div class="mb-3">
					  <label for="spass" class="form-label">Student Password</label>
					 <input type = "password" class="form-control" name = "spassword" id="spass" required placeholder = "Enter Password">
				</div>
				<div class="mb-3">
					  <label for="smobile" class="form-label">Student Mobile No</label>
					   <input type = "text" class="form-control" name = "smobileno" id="smobile" required placeholder = "Enter Mobile NO">
				</div>
				<div class="mb-3">
					  <label for="sem" class="form-label">Semester</label>
					   <input type = "number" class="form-control" name = "studsem" id="sem" required placeholder = "Enter Semester">
				</div>
				<div class="mb-3">
					  <label for="studage" class="form-label">Age</label>
					  <input type = "number" class="form-control" name = "sage" id="studage" required placeholder = "Enter student age">
				</div>
				<div class="mb-3">
	...
	<%
		try{  
			...
			Statement stmt=con.createStatement();  
			ResultSet rs=stmt.executeQuery("select sid,susername,spassword,sname,semester,mobile_no,age,course_name,dept_name from student,course,department where student.course_id = course.course_id and student.dept_id = department.dept_id");  
	%>
	...
	%>
			<tbody>
			    <tr>
			      ...
			      <td><%= coursename %></td>
			      <td><%= deptname %></td>
			      <td><a class="btn btn-danger" href="DeleteStudent.jsp?sid=<%=sid%>" role="button"><i class="fa fa-trash"></i></a></td> 
			    </tr>
			</tbody>
	<% 
		}
